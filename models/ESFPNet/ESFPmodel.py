...
from ESFPNet.Encoder  import mit
from ESFPNet.Decoder import mlp
...
class ESFPNetStructure(nn.Module):
    ...
    def _init_weights(self, model_type = 'B0'):
        ...
        if model_type == 'B0':
            pretrained_dict = torch.load('/project/ahnailab/jsj0414/지역포함_0113/working_path/model/ESFPNet/Pretrained/mit_b0.pth')
