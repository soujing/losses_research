...
###############################################################################위에서는_deit_tiny_distilled_patch16_224_이거_때문에###############################3
...
import timm
import sys
# sys.path.append('/home/jsj0414/facebookresearch/models.py')
# import deit_tiny_distilled_patch16_224
...
class FAT_Net(nn.Module):
    def __init__(self, n_channels=3, n_classes=1):
        ...
        # from facebookresearch.models import deit_tiny_distilled_patch16_224
        # transformer = timm.create_model('deit_tiny_distilled_patch16_224', pretrained=True)
